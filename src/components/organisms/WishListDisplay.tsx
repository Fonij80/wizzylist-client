      ...
      {showAddForm && (
        <Card className="theme-card shadow-lg mb-6">
          <CardHeader>
            ...
            <CardDescription>
              What would you love to receive for your birthday?
            </CardDescription>
          </CardHeader>
          <CardContent>
            <WishListForm
      ...
      {wishList.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {wishList.map((item) => (
            <Card
              key={item.id}
              className={`theme-card shadow-lg transition-all hover:shadow-xl ${
            ...
            >
              <CardContent className="p-0">
                ...
                <div className="p-4">
                  <h3 className="font-semibold text-lg theme-text mb-2">
                    {item.name}
                  </h3>
                  {item.description && (
